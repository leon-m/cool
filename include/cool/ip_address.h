...
#if !defined(IP_ADDRESS_H_HEADER_GUARD)
#define IP_ADDRESS_H_HEADER_GUARD
 ...
 * - @ref operator ==(const cool::net::ip::address& lhs, const cool::net::ip::address& rhs) "comparison operator =="
 * - @ref operator !=(const cool::net::ip::address& lhs, const cool::net::ip::address& rhs) "comparison operator !="
 * - @ref operator <<(std::ostream&, const cool::net::ip::address&) "stream operator <<"
 * - @ref operator >>(std::istream&, cool::net::ip::address&) "stream operator >>"
 */
namespace ip {
...
class address
{
 public:
   ...
   * @ref cool::net::ip::IPv4 "IPv4" host address.
   *
...
class network : public address
{
 public:
   ...
   * not network address of the same @ref cool::net::ip::Version "IP version".
   *
   * @param rhs the IP address to be assigned to this address object
   *
   * @exception exception::illegal_argument if the provided IP address cannot
...
class host : public ip::host
{
 public:
  ...
  virtual ip::Version version() const override { return ip::IPv6;  }
   ...
   *
   * @see @ref cool::net::ipv6::Style "Visual styles for IPv6 addresses"
   */
  void visualize(std::ostream& os, Style style) const;
...
class network : public ip::network
{
 public:
   ...
   * @exception exception::illegal_argument Thrown if mask size exceeds 128 bits.
   */
  explicit network(std::size_t mask_size, const in6_addr& data);
  /**
...
typedef cool::basis::binary<4> binary_t;
...
namespace entrails {
namespace ipv6 {
extern void parse(std::istream&, cool::net::ipv6::host&);
extern void parse(std::istream&, cool::net::ipv6::network&);
extern void parse(std::istream&, cool::net::ip::address&);
}
namespace ipv4 {
extern void parse(std::istream&, cool::net::ipv4::host&);
extern void parse(std::istream&, cool::net::ipv4::network&);
extern void parse(std::istream&, cool::net::ip::address&);
}
}
 ...
 */
inline std::ostream& operator <<(std::ostream& os, const cool::net::ip::address& val)
{
  val.visualize(os);
  return os;
}
 ...
 * recognized presentation styles depend on the @ref cool::net::ip::Version "version"
 * and the @ref cool::net::ip::Kind "kind" of the provided
 * @ref cool::net::ip::address "address" parameter as follows:
 *  - the @ref cool::net::ip::IPv4 "IPv4" addresses are recognized in the
 *    usual dotted format, e.g. <tt>198.18.3.65</tt>
 *  - the @ref cool::net::ip::IPv6 "IPv6" addresses are recognized in all styles
 *    as listed in @ref cool::net::ipv6::Style "Style" enumeration. In addition,
 *    the IPv6 @ref cool::net::ip::host "host" address may be enclosed in square
 *    brackets (<tt>[</tt> ... <tt>]</tt>), which are ignored.
 *
 * For @ref cool::net::ip::network "network" addresses of any
 * @ref cool::net::ip::Version "version" the network mask width can be specified
